      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-dark-400 mt-1">
            {t("sellers.subtitle") || "Manage all sellers and their approvals"}
          </p>
        </div>
        <button
                  ...
                  {sellers.length === 0 ? (
                    ...
                    sellers.map((seller, index) => (
                      ...
                      >
                        ...
                        >
                          <div
                            className={`flex flex-wrap gap-1 ${isRTL ? "justify-end" : ""}`}
                          >
                            {seller.categories.slice(0, 2).map((cat) => (
                              <span
                                key={cat}
                        ...
                        >
                          <p className="text-sm text-white">
                            {formatDate(seller.createdAt, isRTL ? "ar" : "en")}
                          </p>
                          <p className="text-xs text-dark-400">
                            {formatTime(seller.createdAt, isRTL ? "ar" : "en")}
                          </p>
                        </td>
                        ...
                        >
                          ...
                          >
                            <button
                              ...
                              title={t("sellers.viewDetails") || "View Details"}
                            >
                            ...
                            <button
                              onClick={() => showConfirm("delete", seller._id)}
                              className="p-1.5 hover:bg-red-500/20 rounded-lg transition-colors text-red-400 hover:text-red-300"
          ...
          >
            ...
            >
              ...
              <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-white">
                        {selectedSeller.phone
                          ? selectedSeller.phone.replace(/\d/g, (d) =>
                              currentLanguage === "ar"
                                ? formatNumber(Number(d), "ar")
                                : d,
                            )
                          : "N/A"}
                      </p>
                ...
                <div className="p-4 bg-white/5 rounded-xl">
                  <h3 className="text-lg font-semibold text-white mb-3">
                    {t("sellers.details.categories") || "Categories"}
                  </h3>
