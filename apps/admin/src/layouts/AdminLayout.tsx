  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-primary-950/20 to-dark-950">
      ...
      >
        ...
        >
          <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-accent-purple rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/30 flex-shrink-0">
        ...
        <nav className="space-y-1">
          {navItems.map((item, index) => (
            ...
            >
              ...
              >
                <item.icon className="w-5 h-5 group-hover:scale-110 transition-transform text-dark-400 group-hover:text-primary-400 flex-shrink-0" />
        ...
        >
          <div className="p-4 glass rounded-xl border border-white/10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-500 to-accent-purple flex items-center justify-center shadow-lg shadow-primary-500/20 flex-shrink-0">
